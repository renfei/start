...
public class TStartKvStorageExample {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        public Criteria andExpirationEqualTo(Date value) {
            addCriterionForJDBCDate("`expiration` =", value, "expiration");
            return (Criteria) this;
        }
        ...
        public Criteria andExpirationIn(List<Date> values) {
            addCriterionForJDBCDate("`expiration` in", values, "expiration");
            return (Criteria) this;
        }

        public Criteria andExpirationNotIn(List<Date> values) {
            addCriterionForJDBCDate("`expiration` not in", values, "expiration");
            return (Criteria) this;
        }

        public Criteria andExpirationBetween(Date value1, Date value2) {
            addCriterionForJDBCDate("`expiration` between", value1, value2, "expiration");
            return (Criteria) this;
        }

        public Criteria andExpirationNotBetween(Date value1, Date value2) {
            addCriterionForJDBCDate("`expiration` not between", value1, value2, "expiration");
            return (Criteria) this;
        }
    }
